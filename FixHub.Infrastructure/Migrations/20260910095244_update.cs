        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CapacityHp = table.Column<decimal>(type: "numeric(5,2)", nullable: true),
                    CapacityBtu = table.Column<int>(type: "integer", nullable: true),
                    IsInverter = table.Column<bool>(type: "boolean", nullable: false),
                    EnergyRating = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RepairServices_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RepairServiceId = table.Column<Guid>(type: "uuid", nullable: true),
                    Quantity = table.Column<int>(type: "integer", nullable: false),
                    UnitPrice = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    Subtotal = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    ProductNameSnapshot = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    SkuSnapshot = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    ServiceNameSnapshot = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrderDetails_RepairServices_RepairServiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CheckoutFieldsJson = table.Column<string>(type: "text", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderDetails_RepairServiceId",
                table: "OrderDetails",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RepairServices_CategoryId",
